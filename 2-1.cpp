...
Description : This file contains a simple C program that displays student 
...
int main() {
    ...
    // Format spaces, alignment, datatype and precision of values
    printf("| %-20s | %3d | %7.2f |\n", student_1_name, student_1_age, student_1_gpa);
    printf("|----------------------|-----|---------|\n");
